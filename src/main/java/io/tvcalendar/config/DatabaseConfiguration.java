package io.tvcalendar.config;

import io.tvcalendar.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("io.tvcalendar.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.tvcalendar.repository.search")
